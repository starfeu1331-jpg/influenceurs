            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="space-y-1 md:space-y-2">
                ...
                <p className="text-callout md:text-title-3 text-apple-gray-600">
                  Gérez vos campagnes influenceurs
                </p>
              </div>
              <Link
                href="/projects/new"
        ...
        <div className="grid grid-cols-2 gap-3 md:gap-6">
          ...
          <div className="card-glass p-4 md:p-6 hover-lift group">
            ...
            <div className="space-y-0.5 md:space-y-1">
              ...
              <p className="text-caption-2 md:text-footnote text-apple-gray-500">En cours</p>
            </div>
          </div>
          ...
          <div className="card-glass p-4 md:p-6 hover-lift group">
            ...
            <div className="space-y-0.5 md:space-y-1">
              ...
              <p className="text-caption-2 md:text-footnote text-apple-gray-500">Investissement</p>
            </div>
          </div>
        </div>
      </div>
